...
# Принудительное сохранение файла Check_Result.txt на Рабочий стол
...
# --------------------------------------------------------------------------
# СОХРАНЕНИЕ В ФАЙЛ НА РАБОЧЕМ СТОЛЕ
# --------------------------------------------------------------------------
# Команда Out-File гарантрует запись всей информации без сбоев потоков
...
Write-Host "[+] Отчет сохранен на Рабочий стол: $OutputFile" -ForegroundColor Yellow